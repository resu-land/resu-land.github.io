<script lang="ts">
    ...
    const tier2: Array<string> = ['rust', 'lua', 'javascript', 'typescript'];
    const tier3: Array<string> = ['zig', 'v', 'dart', 'apl', 'haskell'];
    const used: Array<string> = ['prolog', 'lisp', 'ml', 'c#', 'php', 'java', 'ruby'];
